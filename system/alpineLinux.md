...
- 国内镜像源
  1. 清华TUNA镜像源：[https://mirror.tuna.tsinghua.edu.cn/alpine/](https://mirror.tuna.tsinghua.edu.cn/alpine/)
  2. 中科大镜像源：[http://mirrors.ustc.edu.cn/alpine/](http://mirrors.ustc.edu.cn/alpine/)
  3. 阿里云镜像源：[http://mirrors.aliyun.com/alpine/](http://mirrors.aliyun.com/alpine/)
- 手动替换apk源
...
- **update：从远程镜像源中更新本地镜像源索引**
  ...
  >update 命令会从各个镜像源列表下载 apkindex.tar.gz 并存储到本地缓存，
...
- **rc-service**
  ...
  - **rc-service语法格式**
    ```bash
    Usage:
          rc-service [options] [-i] <service> <cmd>...
