...
[root@system1 ~]$ p 		# primary (0 primary, 0 extended, 4 free)
[root@system1 ~]$ 2 		# Partition number
[root@system1 ~]$ 2048  # First sector (2048-104853470, default 2048)
[root@system1 ~]$ +567M # Last sector, +sectors or +size{K,M,G,T,P}
[root@system1 ~]$ t 		# Partition number
[root@system1 ~]$ 82		# changed type of Partition "Linux" to "Linux swap"
[root@system1 ~]$ w			# save
